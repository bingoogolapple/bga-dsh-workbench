...
function spawnParticles(rect, count, random, colors) {
...
function runConfettiBurst(rect, options = {}) {
  ...
  const particles = spawnParticles(rect, count, clock.random, THEME_COLORS[theme]);
  let running = true;
  let frameId = 0;
  let lastTime;
...
var TASK_EXECUTION_EVENT = "bga-dsh-workbench:task-execution";
...
async function fetchConfettiConfig() {
  const fallback = { theme: "default", intensity: "large", trigger: "success" };
  try {
    ...
    const theme = typeof c.theme === "string" && ["default", "gold", "ocean", "sakura", "neon"].includes(c.theme) ? c.theme : fallback.theme;
    const intensity = typeof c.intensity === "string" && ["small", "medium", "large", "epic"].includes(c.intensity) ? c.intensity : fallback.intensity;
    const trigger = typeof c.trigger === "string" && ["success", "every", "task"].includes(c.trigger) ? c.trigger : fallback.trigger;
...
function ConfettiLayer({
  ...
  const loadConfigRef = (0, import_react3.useRef)(loadConfettiConfig);
  ...
  (0, import_react3.useEffect)(() => {
    ...
    let confettiTheme = "gold";
    let confettiIntensity = "large";
    let confettiTrigger = "success";
    ...
    const observer = new MutationObserver((records) => {
      ...
      if (confettiTrigger === "task") {
        ...
        eligible = gateSkipped ? [] : freshTails.filter((tail) => isBottomMost(tail) && !isStoppedTurn(tail));
      } else {
        eligible = !gateSkipped ? freshTails.filter((tail) => isBottomMost(tail) && !isStoppedTurn(tail)) : [];
      }
...
var englishApi = {
  ...
  reset: () => post("/reset"),
  // Wrong word notebook
  wrongWords: () => get("/wrong-words"),
  clearWrongWords: () => post("/wrong-words/clear"),
  removeWrongWord: (itemId) => post("/wrong-words/remove", { itemId }),
  // Frequency settings
  setFrequency: (frequency, dailyQuizLimit) => post("/frequency", { frequency, dailyQuizLimit }),
  // Dashboard
...
function EnglishLearningLayer() {
  ...
  const turnsSinceQuizRef = (0, import_react4.useRef)(0);
  const frequencyRef = (0, import_react4.useRef)("every-turn");
  const dailyLimitRef = (0, import_react4.useRef)(10);
  const quizzesTodayRef = (0, import_react4.useRef)(0);
  const quizzesDateRef = (0, import_react4.useRef)("");
...
function EnglishSettings(_props) {
  ...
  const [sessionSize, setSessionSize] = (0, import_react5.useState)(1);
  ...
  const [wrongWords, setWrongWords] = (0, import_react5.useState)([]);
  ...
  const onFrequencyChange = async (frequency) => {
    try {
      const res = await englishApi.setFrequency(frequency, state?.dailyQuizLimit);
      if (res.ok) {
        setState(res.state);
        setMessage({ kind: "ok", text: "\u5B66\u4E60\u9891\u7387\u5DF2\u66F4\u65B0" });
      }
    } catch {
      setMessage({ kind: "error", text: "\u66F4\u65B0\u9891\u7387\u5931\u8D25" });
    }
  };
  const onDailyLimitChange = async (limit) => {
    try {
  ...
  const onRemoveWrongWord = async (itemId) => {
    try {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { minWidth: 0 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { display: "flex", gap: 8 }, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { flex: "0 0 48%", display: "flex", alignItems: "center", gap: 8 }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { type: "number", min: 1, max: 10, style: { ...inputStyle2, minWidth: 0, flex: 1 }, value: sessionSize, onChange: (e) => setSessionSize(Number(e.target.value)) })
          ] }) })
        ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { style: { ...subH3Style, marginTop: 6 }, children: "\u5B66\u4E60\u9891\u7387" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: rowStyle2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: labelStyle, children: "\u7B54\u9898\u9891\u7387" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("select", { style: { ...inputStyle2, flex: 1 }, value: state?.frequency ?? "every-turn", onChange: (e) => void onFrequencyChange(e.target.value), children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "every-turn", children: "\u6BCF\u8F6E\u5BF9\u8BDD\u540E" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "every-2", children: "\u6BCF 2 \u8F6E\u540E" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "every-5", children: "\u6BCF 5 \u8F6E\u540E" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "every-10", children: "\u6BCF 10 \u8F6E\u540E" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "manual", children: "\u4EC5\u624B\u52A8\u89E6\u53D1" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: rowStyle2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: labelStyle, children: "\u6BCF\u65E5\u4E0A\u9650" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { style: { ...inputStyle2, width: 80 }, type: "number", min: 0, max: 50, value: state?.dailyQuizLimit ?? 10, onChange: (e) => void onDailyLimitChange(Number(e.target.value)) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: captionStyle, children: "\u6B21\uFF080 = \u4E0D\u9650\uFF09" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { style: { ...subH3Style, marginTop: 6 }, children: "\u9519\u8BCD\u672C" }),
    wrongWords.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { ...captionStyle, padding: "8px 0" }, children: "\u6682\u65E0\u9519\u8BCD" }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { maxHeight: 200, overflowY: "auto", border: "1px solid var(--dsw-alias-border-l2, #eee)", borderRadius: 8, marginBottom: 8 }, children: wrongWords.map((w) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 10px", borderBottom: "1px solid var(--dsw-alias-border-l2, #f5f5f5)" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontWeight: 600, fontSize: 13 }, children: w.text }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: "var(--dsw-alias-label-secondary, #666)", fontSize: 12, marginLeft: 8 }, children: w.meaning }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { color: "var(--dsw-alias-label-tertiary, #999)", fontSize: 11, marginLeft: 8 }, children: [
            "\u9519 ",
            w.wrongCount,
            " \u6B21"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", style: { ...buttonStyle, padding: "2px 8px", fontSize: 11 }, onClick: () => void onRemoveWrongWord(w.itemId), children: "\u79FB\u9664" })
      ] }, w.itemId)) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", style: { ...buttonStyle, color: "var(--dsw-alias-state-error-primary, #c00000)", borderColor: "var(--dsw-alias-state-error-primary, #c00000)" }, onClick: () => void onClearWrongWords(), children: "\u6E05\u7A7A\u9519\u8BCD\u672C" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { style: { ...subH3Style, marginTop: 6 }, children: "\u5B66\u4E60\u62A5\u544A" }),
    dashboard !== null ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, padding: "8px 0" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { textAlign: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 20, fontWeight: 700, color: "var(--dsw-alias-brand-primary, #0070f3)" }, children: dashboard.xp }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary, #999)" }, children: "\u603B XP" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { textAlign: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 20, fontWeight: 700, color: "#ff6b35" }, children: dashboard.streak }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary, #999)" }, children: "\u8FDE\u7EED\u5929\u6570" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { textAlign: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { fontSize: 20, fontWeight: 700, color: "var(--dsw-alias-state-success-primary, #2e8e52)" }, children: [
          dashboard.masteredCards,
          "/",
          dashboard.totalCards
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary, #999)" }, children: "\u5DF2\u638C\u63E1\u5361" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { textAlign: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 20, fontWeight: 700 }, children: dashboard.totalCompleted }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary, #999)" }, children: "\u5DF2\u638C\u63E1\u8BCD" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { textAlign: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 20, fontWeight: 700, color: "var(--dsw-alias-state-error-primary, #c00000)" }, children: dashboard.totalWrong }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary, #999)" }, children: "\u9519\u8BCD\u6570" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { textAlign: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { fontSize: 20, fontWeight: 700 }, children: [
          dashboard.statistics.answers > 0 ? Math.round(dashboard.statistics.correct / dashboard.statistics.answers * 100) : 0,
          "%"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary, #999)" }, children: "\u6B63\u786E\u7387" })
      ] })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { ...captionStyle, padding: "8px 0" }, children: "\u52A0\u8F7D\u4E2D..." }),
...
// src/client/SupportAuthorSection.tsx
var import_react6 = require("react");
var import_jsx_runtime4 = require("react/jsx-runtime");
var OPENCODE_GO_URL = "https://opencode.ai/go?ref=8CYK5082AG";
var GOD_ASSISTANT_URL = "https://github.com/bingoogolapple/bga-god-assistant-config";
var DSH_CLIENT_URL = "https://github.com/bingoogolapple/bga-dsh-client";
var cardStyle2 = {
  background: "var(--dsw-alias-bg-layer, #fff)",
  border: "1px solid var(--dsw-alias-border-l2, #ddd)",
  borderRadius: 10,
...
var h3Style2 = { fontSize: 15, margin: "0 0 8px" };
var subH3Style2 = { fontSize: 13, margin: "12px 0 6px", fontWeight: 600 };
var paragraphStyle = {
  fontSize: 13,
  lineHeight: 1.7,
  margin: "4px 0",
...
function SupportAuthorSection() {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: cardStyle2, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { style: h3Style2, children: "\u652F\u6301\u4F5C\u8005" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h4", { style: subH3Style2, children: "\u6253\u8D4F\u652F\u6301\u4F5C\u8005" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { style: paragraphStyle, children: [
      "\u4F5C\u8005\u4E3B\u8981\u4F7F\u7528\u7684 Coding Plan \u662F ",
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SupportLink, { href: OPENCODE_GO_URL, children: "OpenCode Go" }),
      "\uFF0C \u57FA\u4E8E\u5F00\u6E90\u7684 ",
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SupportLink, { href: OPENCODE_GO_URL, children: "opencode.ai" }),
      " \u63D0\u4F9B\u4E91\u7AEF\u8BA2\u9605\uFF08OpenCode Go\uFF09\u3002 \u901A\u8FC7\u4F5C\u8005\u7684\u9080\u8BF7\u94FE\u63A5 ",
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SupportLink, { href: OPENCODE_GO_URL, children: "\u8BA2\u9605 OpenCode Go" }),
      "\uFF0C\u60A8\u548C\u4F5C\u8005\u5404\u53EF\u5F97 $5 \u8BA2\u9605\u989D\u5EA6\u2014\u2014\u6B22\u8FCE\u901A\u8FC7\u6B64\u94FE\u63A5\u652F\u6301\u4F5C\u8005\uFF0C\u611F\u8C22\uFF01"
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: captionStyle2, children: "OpenCode Go \u5305\u542B\u4EE5\u4E0B\u4F7F\u7528\u989D\u5EA6\u9650\u5236\uFF0C\u4F7F\u7528\u4FBF\u5B9C\u70B9\u7684\u6A21\u578B\u51E0\u4E4E\u4E0D\u4F1A\u6709 Token \u7126\u8651\uFF1A" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("ul", { style: listStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("li", { children: "5 \u5C0F\u65F6\u9650\u5236 \u2014 12 \u7F8E\u5143\u4F7F\u7528\u989D\u5EA6" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("li", { children: "\u6BCF\u5468\u9650\u5236 \u2014 30 \u7F8E\u5143\u4F7F\u7528\u989D\u5EA6" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("li", { children: "\u6BCF\u6708\u9650\u5236 \u2014 60 \u7F8E\u5143\u4F7F\u7528\u989D\u5EA6" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h4", { style: subH3Style2, children: "\u4F5C\u8005\u9879\u76EE\u63A8\u8350" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { style: paragraphStyle, children: [
      "\xB7 \u6B22\u8FCE\u60A8\u4F7F\u7528\u4F5C\u8005\u5F00\u53D1\u7684\u7B2C\u4E00\u4E2A\u72EC\u7ACB\u5F00\u53D1\u8F6F\u4EF6\u4EA7\u54C1",
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SupportLink, { href: GOD_ASSISTANT_URL, children: " \u4E0A\u5E1D\u5C0F\u52A9\u624B\u6D4F\u89C8\u5668\u6269\u5C55/\u63D2\u4EF6\u5F00\u53D1\u5E73\u53F0" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { style: paragraphStyle, children: [
      "\xB7 \u6B22\u8FCE\u60A8\u4F7F\u7528\u4F5C\u8005\u7684\u53E6\u4E00\u4E2A DSH \u9879\u76EE",
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SupportLink, { href: DSH_CLIENT_URL, children: " DSH \u684C\u9762\u5BA2\u6237\u7AEF\uFF08bga-dsh-client\uFF09" }),
...
var captionStyle3 = { fontSize: 12, color: "var(--dsw-alias-label-tertiary, #888)" };
var buttonStyle2 = {
  padding: "4px 12px",
  borderRadius: 8,
  border: "1px solid var(--dsw-alias-border-l2, #ccc)",
...
function SettingsSection({ load, save, saveConfetti, uploadAvatar, resetAvatar, saveOpenPrefs, saveExtraOpen }) {
  ...
  const [avatarPath, setAvatarPath] = (0, import_react7.useState)("");
  const [text, setText] = (0, import_react7.useState)("");
  const [show, setShow] = (0, import_react7.useState)(true);
  const [sound, setSound] = (0, import_react7.useState)(true);
  const [confettiShow, setConfettiShow] = (0, import_react7.useState)(true);
  const [theme, setTheme] = (0, import_react7.useState)("default");
  const [intensity, setIntensity] = (0, import_react7.useState)("large");
  const [trigger, setTrigger] = (0, import_react7.useState)("success");
  const [revision, setRevision] = (0, import_react7.useState)(0);
  const [busy, setBusy] = (0, import_react7.useState)(false);
  const [terminal, setTerminal] = (0, import_react7.useState)("");
  const [editor, setEditor] = (0, import_react7.useState)("");
  const [openExtra, setOpenExtra] = (0, import_react7.useState)({});
  const [message, setMessage] = (0, import_react7.useState)(null);
  const callbacks = (0, import_react7.useRef)({ load, save, saveConfetti, uploadAvatar, resetAvatar, saveOpenPrefs, saveExtraOpen });
  callbacks.current = { load, save, saveConfetti, uploadAvatar, resetAvatar, saveOpenPrefs, saveExtraOpen };
  const savedTextRef = (0, import_react7.useRef)("");
  const latestTextRef = (0, import_react7.useRef)("");
  const saveTimerRef = (0, import_react7.useRef)(void 0);
  const flashTimerRef = (0, import_react7.useRef)(void 0);
  ...
  const onIntensityChange = async (next) => {
  ...
  const onTriggerChange = async (next) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h3", { style: { fontSize: 15, margin: "0 0 8px" }, children: "\u5DE5\u4F5C\u53F0\u6A2A\u5E45" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: "\u6A2A\u5E45\u603B\u5F00\u5173" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 13 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("input", { type: "checkbox", checked: show, disabled: busy, onChange: (event) => onToggleShow(event.target.checked) }),
          "\u5728\u7A7A\u6001\u9876\u90E8\u663E\u793A\u6A2A\u5E45"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: "\u5934\u50CF" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", style: buttonStyle2, disabled: busy, onClick: () => fileRef.current?.click(), children: "\u66F4\u6362\u56FE\u7247" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "input",
          {
            ref: fileRef,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", style: buttonStyle2, disabled: busy, onClick: onReset, children: "\u6062\u590D\u9ED8\u8BA4" })
      ] }),
      avatarPath.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { ...rowStyle3, paddingTop: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: captionStyle3, children: avatarPath }) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: "\u95EE\u5019\u8BED" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "input",
          {
            style: inputStyle3,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: captionStyle3, children: "\u8F93\u5165\u540E\u81EA\u52A8\u4FDD\u5B58" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: {
      background: "var(--dsw-alias-bg-layer, #fff)",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h3", { style: { fontSize: 15, margin: "0 0 8px" }, children: "\u5F69\u5E26\u914D\u7F6E" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: "\u5F69\u5E26\u603B\u5F00\u5173" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 13 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("input", { type: "checkbox", checked: confettiShow, disabled: busy, onChange: (event) => onToggleConfettiShow(event.target.checked) }),
          "\u542F\u7528\u5F69\u5E26\u7279\u6548\uFF08\u5173\u95ED\u540E\u4E0D\u64AD\u653E\u7279\u6548\u4E0E\u97F3\u6548\uFF09"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: "\u5F69\u5E26\u97F3\u6548" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 13 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("input", { type: "checkbox", checked: sound, disabled: busy, onChange: (event) => onToggleSound(event.target.checked) }),
          "\u6574\u8F6E\u5B8C\u6210\u65F6\u64AD\u653E\u5E86\u795D\u97F3\u6548"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", style: buttonStyle2, disabled: busy, onClick: onPreviewSound, children: "\u8BD5\u542C" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: t("confetti.theme") }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "default", children: t("confetti.theme.default") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "gold", children: t("confetti.theme.gold") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "ocean", children: t("confetti.theme.ocean") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "sakura", children: t("confetti.theme.sakura") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "neon", children: t("confetti.theme.neon") })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: t("confetti.intensity") }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "select",
          {
            style: narrowInputStyle,
            value: intensity,
            disabled: busy,
            onChange: (event) => void onIntensityChange(event.target.value),
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "small", children: t("confetti.intensity.small") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "medium", children: t("confetti.intensity.medium") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "large", children: t("confetti.intensity.large") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "epic", children: t("confetti.intensity.epic") })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: t("confetti.trigger") }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "select",
          {
            style: narrowInputStyle,
            value: trigger,
            disabled: busy,
            onChange: (event) => void onTriggerChange(event.target.value),
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "success", children: t("confetti.trigger.success") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "every", children: t("confetti.trigger.every") }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "task", children: t("confetti.trigger.task") })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: captionStyle3, children: "\u300C\u4EC5\u4EFB\u52A1\u6267\u884C\u300D\u65F6\u666E\u901A\u5BF9\u8BDD\u4E0D\u518D\u6492\u5F69\u5E26" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(EnglishSettings, {}),
    message !== null && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: message.kind === "ok" ? okStyle2 : errorStyle2, children: message.text }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: {
      background: "var(--dsw-alias-bg-layer, #fff)",
      border: "1px solid var(--dsw-alias-border-l2, #ddd)",
      borderRadius: 10,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h3", { style: { fontSize: 15, margin: "0 0 8px" }, children: "\u5DE5\u4F5C\u533A\u6253\u5F00\u65B9\u5F0F" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: "\u9ED8\u8BA4\u7EC8\u7AEF" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "select",
          {
            style: narrowInputStyle,
            ...
            children: terminalOptionsFor(currentPlatform()).map((option) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: option.id, children: option.label }, option.id))
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: captionStyle3, children: "\u6253\u5F00\u76EE\u5F55\u65F6\u4F7F\u7528\u7684\u7EC8\u7AEF\uFF08\u4EC5\u663E\u793A\u5F53\u524D\u5E73\u53F0\u53EF\u7528\u9879\uFF09" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: rowStyle3, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: labelStyle2, children: "\u9ED8\u8BA4\u7F16\u8F91\u5668" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "select",
          {
            style: inputStyle3,
            ...
            children: EDITOR_OPTIONS.map((option) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: option.id, children: option.label }, option.id))
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: captionStyle3, children: "\u6253\u5F00\u76EE\u5F55\u65F6\u4F7F\u7528\u7684\u7F16\u8F91\u5668" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, margin: "12px 0 0" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h3", { style: { fontSize: 13, margin: 0, fontWeight: 600 }, children: "\u9644\u52A0\u6253\u5F00\u65B9\u5F0F" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: captionStyle3, children: "\u52FE\u9009\u540E\u5C55\u793A\u5728\u5DE5\u4F5C\u533A\u83DC\u5355\u5C3E\u90E8\uFF08\u9ED8\u8BA4\u5168\u5F00\uFF09" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { display: "flex", flexWrap: "wrap", gap: 12, marginTop: 8 }, children: EXTRA_OPEN_KINDS.map((kind, _index) => {
        const key = extraSettingKey(kind);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SupportAuthorSection, {})
  ] });
}
...
var TASK_KINDS = ["todo", "task"];
var TASK_PRIORITIES = ["high", "medium", "low"];
var SUPPORT_STATUSES = ["pending", "processing", "resolved"];
...
function isSupportStatus(value) {
  return typeof value === "string" && SUPPORT_STATUSES.includes(value);
}
function normalizeSupportStatus(value) {
  return isSupportStatus(value) ? value : void 0;
}
...
function normalizeCategory(value) {
  return isTaskCategory(value) ? value : void 0;
}
function normalizePriority(value) {
  return isTaskPriority(value) ? value : void 0;
}
function normalizeDate(value) {
  return isDateString(value) ? value : void 0;
}
...
function isTaskRecord(value) {
  ...
  if (record.schedule !== void 0 && !isScheduleRule(record.schedule)) return false;
  return true;
}
function isExecutionRecord(value) {
  ...
  if (record.sessionId !== void 0 && typeof record.sessionId !== "string") return false;
  if (record.endedAt !== void 0 && (typeof record.endedAt !== "number" || !Number.isFinite(record.endedAt))) return false;
  if (record.result !== void 0 && !["succeeded", "failed", "cancelled"].includes(String(record.result))) return false;
  return record.error === void 0 || typeof record.error === "string";
}
function isScheduleRule(value) {
  if (typeof value !== "object" || value === null) return false;
  const record = value;
  if (typeof record.enabled !== "boolean" || typeof record.cron !== "string") return false;
  if (record.nextRunAt !== void 0 && typeof record.nextRunAt !== "number") return false;
  if (record.lastTriggeredAt !== void 0 && typeof record.lastTriggeredAt !== "number") return false;
  return true;
}
...
function createTask(input, now, id) {
  return {
    ...
    kind: isTaskKind(input.kind) ? input.kind : void 0,
...
var MAX_MONTH_DAYS = [0, 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
function isImpossibleDate(schedule) {
...
function nextRunAtMs(expr, fromMs) {
  ...
  if (isImpossibleDate(schedule)) return void 0;
...
function applyUpdateTask(tasks, id, patch, now) {
  return tasks.map((task) => {
    ...
    if ("workspaceId" in patch) next.workspaceId = normalizeTargetId2(patch.workspaceId);
    if ("mode" in patch) next.mode = normalizeTargetId2(patch.mode);
    if ("permission" in patch) {
      const value = patch.permission;
      next.permission = value === void 0 ? void 0 : isTaskPermission(value) ? value : task.permission;
    }
    ...
    if ("supportStatus" in patch) {
      ...
      next.supportStatus = value === void 0 ? void 0 : isSupportStatus(value) ? value : task.supportStatus;
    }
    return next;
  });
}

// src/core/workbench-meta.ts
...
function emptyWorkbenchMeta(now) {
  return {
    dayDoneAt: {},
    updatedAt: now,
    weekStart: "monday",
...
function isWorkbenchMeta(value) {
  if (typeof value !== "object" || value === null) return false;
  const record = value;
  ...
  for (const [key, ts] of Object.entries(record.dayDoneAt)) {
    if (typeof key !== "string" || !/^\d{4}-\d{2}-\d{2}$/.test(key)) return false;
    if (typeof ts !== "number" || !Number.isFinite(ts)) return false;
  }
  if (record.weekStart !== void 0 && record.weekStart !== "monday" && record.weekStart !== "sunday") return false;
  if (record.categories !== void 0) {
  ...
  if (record.reminder !== void 0) {
    ...
    if (reminder.lastTriggeredAt !== void 0 && typeof reminder.lastTriggeredAt !== "number") return false;
  }
  return true;
}
function categoriesOf(meta) {
  return meta.categories !== void 0 && meta.categories.length > 0 ? meta.categories : DEFAULT_CATEGORIES;
}
function categoryLabelOf(meta, id) {
  const found = categoriesOf(meta).find((def) => def.id === id);
  return found?.label ?? id;
}
function weekStartOf(meta) {
  return meta.weekStart ?? "monday";
}
function setWeekStart(meta, weekStart, now) {
  return { ...meta, weekStart, updatedAt: now };
}
function setCategories(meta, categories, now) {
  return { ...meta, categories: [...categories], updatedAt: now };
}
function addCategory(meta, def, now) {
  const current = categoriesOf(meta);
  if (current.some((item) => item.id === def.id)) return meta;
  return setCategories(meta, [...current, def], now);
}
function removeCategory(meta, id, now) {
  const current = categoriesOf(meta);
  if (current.length <= 1) return meta;
  return setCategories(meta, current.filter((item) => item.id !== id), now);
}
function setReminder(meta, patch, now) {
  const prev = meta.reminder;
  return {
    ...meta,
    reminder: {
      enabled: patch.enabled ?? prev?.enabled ?? false,
      cron: patch.cron !== void 0 ? patch.cron : prev?.cron ?? "0 21 * * *",
      lastTriggeredAt: prev?.lastTriggeredAt
    },
    updatedAt: now
  };
}
function markReminderTriggered(meta, now) {
  const prev = meta.reminder;
  if (prev === void 0) return meta;
  return {
    ...meta,
...
function markDayDone(meta, date, now) {
  return {
    ...meta,
...
function unmarkDayDone(meta, date, now) {
...
function isDayMarked(meta, date) {
  return meta.dayDoneAt[date] !== void 0;
}
function toggleDayDone(meta, date, now) {
...
var BoardController = class {
  ...
  toggleDayDone(date) {
    this.meta = toggleDayDone(this.meta, date, this.now());
    this.persistAndNotify();
  }
  /** 设置周起始日偏好（monday/sunday），持久化并通知 */
  setWeekStart(weekStart) {
    this.meta = setWeekStart(this.meta, weekStart, this.now());
    this.persistAndNotify();
  }
  /** 替换整张分类配置表（分类管理弹窗提交），持久化并通知 */
  setCategories(categories) {
    this.meta = setCategories(this.meta, categories, this.now());
    this.persistAndNotify();
  }
  /** 追加一个分类（id 冲突时忽略） */
  addCategory(def) {
    this.meta = addCategory(this.meta, def, this.now());
    this.persistAndNotify();
  }
  /** 删除一个分类（任务引用该分类时变为「未分类」显示） */
  removeCategory(id) {
    this.meta = removeCategory(this.meta, id, this.now());
    this.persistAndNotify();
  }
  /** 更新日报提醒配置（启用 + cron） */
  setReminder(patch) {
    this.meta = setReminder(this.meta, patch, this.now());
    this.persistAndNotify();
  }
  /** 记录一次日报提醒触发（去重用），持久化 */
  markReminderTriggered() {
    this.meta = markReminderTriggered(this.meta, this.now());
    this.persistAndNotify();
  }
  /** 订阅快照变化，返回取消订阅函数 */
  subscribe(fn) {
  ...
  onSessionsChanged() {
    ...
    if (this.lastCurrent !== void 0 && current !== this.lastCurrent) this.closeBoard();
...
function preferredWorkspaceId(sessions, workspaces) {
  const current = sessions.current;
  if (current !== void 0) {
    const owning = workspaces.items.find((item) => item.sessionIds?.includes(current) === true);
    if (owning !== void 0) return owning.workspaceId;
  }
...
// src/core/workbench-meta-store.ts
var META_URL = "/bga-dsh-workbench/workbench-meta";
var WorkbenchMetaStore = class {
  /** 读取元数据：GET 端点并解析；文件缺失/非法时回退空元数据（不抛错） */
  load(now = Date.now()) {
    try {
      const xhr = new XMLHttpRequest();
      xhr.open("GET", META_URL, false);
      xhr.send();
      if (xhr.status === 200) {
        const data = JSON.parse(xhr.responseText);
...
var kanban_default = {
  ...
  "bga-kb-viewbar": "kanban_bga-kb-viewbar",
  "bga-kb-viewbar-tabs": "kanban_bga-kb-viewbar-tabs",
  ...
  "bga-kb-fld-row": "kanban_bga-kb-fld-row",
  ...
  "bga-kb-phrase-list": "kanban_bga-kb-phrase-list"
};

// src/client/task-board/board/ConfirmDialog.tsx
var import_react9 = require("react");

// src/client/task-board/board/useDialogFocus.ts
...
function ConfirmDialog({ title, message, confirmLabel, danger, onCancel, onConfirm }) {
  ...
  return (
    ...
    }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { ref: dialogRef, className: kanban_default["bga-kb-modal-sm"], role: "alertdialog", "aria-label": title, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { className: kanban_default["bga-kb-modal-title"], children: title }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: kanban_default["bga-kb-modal-msg"], children: message }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("footer", { className: kanban_default["bga-kb-modal-foot"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-ghost"], onClick: onCancel, children: t("delete.cancel") }),
...
// src/client/task-board/board/MatrixView.tsx
var import_react13 = require("react");
var import_react_dom3 = require("react-dom");

// src/core/matrix.ts
var WEEKDAY_OFFSETS = [0, 1, 2, 3, 4, 5, 6];
...
function mondayOf(date, weekStart = "monday") {
...
function categoriesOf2(categories) {
  return categories !== void 0 && categories.length > 0 ? categories : DEFAULT_CATEGORIES;
}
function byPriorityThenCreatedAt(a, b) {
  const rank = (p) => {
    if (p === "high") return 0;
...
function tasksOfDay(tasks, date) {
  return tasks.filter(
    (task) => task.archivedAt === void 0 && task.reportDate === date && task.category !== void 0
  );
}
function dayStatus(tasks, date, dayDoneAt) {
  const dayTasks = tasksOfDay(tasks, date);
  if (dayTasks.length === 0) return "empty";
  const allDone = dayTasks.every((task) => task.status === "done");
  const marked = dayDoneAt[date] !== void 0;
...
function categoryTasksOnDay(tasks, category, date) {
  return tasks.filter(
    (task) => task.category === category && task.reportDate === date && task.archivedAt === void 0
  );
}
function dayReportMarkdown(tasks, date, categories) {
  const weekday = weekdayName(date);
  const lines = [`# \u65E5\u62A5 ${date}\uFF08${weekday}\uFF09`, ""];
  for (const def of categoriesOf2(categories)) {
...
function weekReportMarkdown(tasks, start, categories) {
  const days = weekDays(start);
  const lines = [`# \u5468\u62A5 ${days[0]} ~ ${days[6].slice(5)}`, ""];
  let total = 0;
  for (const def of categoriesOf2(categories)) {
    const items = [];
...
function toPlainReport(markdown) {
  return markdown.split("\n").map((line) => {
    const stripped = line.replace(/^#{1,2} /, "").replace(/^[-•] /, "");
    return stripped.trimEnd();
  }).join("\n").trim();
}
function supportSuffix(task) {
...
// src/client/task-board/matrix.module.css
var matrix_default = {
  "bga-mx": "matrix_bga-mx",
  "bga-mx-toolbar": "matrix_bga-mx-toolbar",
  "bga-mx-week-nav": "matrix_bga-mx-week-nav",
  "bga-mx-toolbar-right": "matrix_bga-mx-toolbar-right",
  "bga-mx-export": "matrix_bga-mx-export",
  "bga-mx-export-menu": "matrix_bga-mx-export-menu",
  "bga-mx-export-hint": "matrix_bga-mx-export-hint",
  "bga-mx-grid": "matrix_bga-mx-grid",
  "bga-mx-rowhead": "matrix_bga-mx-rowhead",
  "bga-mx-corner": "matrix_bga-mx-corner",
  "bga-mx-rowhead-cell": "matrix_bga-mx-rowhead-cell",
  "bga-mx-rowhead-name": "matrix_bga-mx-rowhead-name",
  "bga-mx-rowhead-count": "matrix_bga-mx-rowhead-count",
  "bga-mx-daycol": "matrix_bga-mx-daycol",
  "bga-mx-dayhead-date": "matrix_bga-mx-dayhead-date",
  "bga-mx-dayhead": "matrix_bga-mx-dayhead",
  "bga-mx-dayhead-num": "matrix_bga-mx-dayhead-num",
  "bga-mx-dayhead-week": "matrix_bga-mx-dayhead-week",
  "bga-mx-dayhead-today": "matrix_bga-mx-dayhead-today",
  "bga-mx-dayhead-badge": "matrix_bga-mx-dayhead-badge",
  "bga-mx-cell": "matrix_bga-mx-cell",
  "bga-mx-cell-add": "matrix_bga-mx-cell-add",
  "bga-mx-task": "matrix_bga-mx-task",
  "bga-mx-task-check": "matrix_bga-mx-task-check",
  "bga-mx-task-title": "matrix_bga-mx-task-title",
  "bga-mx-task-due": "matrix_bga-mx-task-due",
  "bga-mx-prio": "matrix_bga-mx-prio",
  "bga-mx-task-exec": "matrix_bga-mx-task-exec",
  "bga-mx-task-spinner": "matrix_bga-mx-task-spinner",
  "bga-mx-spin": "matrix_bga-mx-spin",
  "bga-mx-weekstart": "matrix_bga-mx-weekstart",
  "bga-kb-btn-ghost": "matrix_bga-kb-btn-ghost",
  "bga-kb-btn-primary": "matrix_bga-kb-btn-primary",
  "bga-mx-support": "matrix_bga-mx-support",
  "bga-mx-stats": "matrix_bga-mx-stats",
  "bga-mx-stats-empty": "matrix_bga-mx-stats-empty",
  "bga-mx-stats-row": "matrix_bga-mx-stats-row",
  "bga-mx-stats-label": "matrix_bga-mx-stats-label",
  "bga-mx-stats-bar": "matrix_bga-mx-stats-bar",
  "bga-mx-stats-fill": "matrix_bga-mx-stats-fill",
  "bga-mx-stats-num": "matrix_bga-mx-stats-num",
  "bga-mx-stats-total": "matrix_bga-mx-stats-total",
  "bga-mx-stats-close": "matrix_bga-mx-stats-close",
  "bga-mx-cat-list": "matrix_bga-mx-cat-list",
  "bga-mx-cat-item": "matrix_bga-mx-cat-item",
  "bga-mx-cat-id": "matrix_bga-mx-cat-id",
  "bga-mx-cat-name": "matrix_bga-mx-cat-name",
  "bga-mx-cat-new": "matrix_bga-mx-cat-new",
  "bga-kb-input": "matrix_bga-kb-input",
  "bga-mx-cat-note": "matrix_bga-mx-cat-note",
  "bga-mx-reminder": "matrix_bga-mx-reminder"
};
...
function NewTaskModal({ controller, onClose, prefill }) {
  ...
  const [category, setCategory] = (0, import_react10.useState)(prefill?.category ?? "");
  const [catDefs, setCatDefs] = (0, import_react10.useState)(() => categoriesOf(controller.getSnapshot().meta));
  const [reportDate, setReportDate] = (0, import_react10.useState)(prefill?.reportDate ?? toDateKey(/* @__PURE__ */ new Date()));
  const [priority, setPriority] = (0, import_react10.useState)("");
  const [kind, setKind] = (0, import_react10.useState)("todo");
  const [workspaceId, setWorkspaceId] = (0, import_react10.useState)("");
  const [mode, setMode] = (0, import_react10.useState)("");
  const [permission, setPermission] = (0, import_react10.useState)("");
  ...
  const submit = () => {
    const task = controller.createTask({
      ...
      reportDate: reportDate === "" ? void 0 : reportDate,
  ...
  return (0, import_react_dom.createPortal)(
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: kanban_default["bga-kb-modal-bg"], onMouseDown: (event) => {
      ...
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h2", { className: kanban_default["bga-kb-modal-title"], children: t("board.new") }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.title") }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: kanban_default["bga-kb-fld-row"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.category") }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "", children: t("new.categoryNone") }),
                    catDefs.map((def) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: def.id, children: def.label }, def.id))
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.reportDate") }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                "input",
                {
                  className: kanban_default["bga-kb-input"],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: kanban_default["bga-kb-fld-row"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.priority") }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                "select",
                {
                  className: kanban_default["bga-kb-select"],
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "", children: t("new.priorityNone") }),
                    ["high", "medium", "low"].map((id) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: id, children: t(`new.priority.${id}`) }, id))
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.kind") }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                "select",
                {
                  className: kanban_default["bga-kb-select"],
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "todo", children: t("new.kind.todo") }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "task", children: t("new.kind.task") })
                  ]
                }
              )
            ] })
          ] }),
          category !== "" && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: kanban_default["bga-kb-fld"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.phrases") }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: kanban_default["bga-kb-phrase-list"], children: phraseTemplates(category).map((phrase) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.description") }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "textarea",
              {
                className: kanban_default["bga-kb-input"],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.prompt") }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "textarea",
              {
                className: kanban_default["bga-kb-input"],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.workspace") }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
              "select",
              {
                className: kanban_default["bga-kb-select"],
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "", children: t("exec.workspace.recent") }),
                  options.workspaces.map((workspace) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: workspace.workspaceId, children: workspace.title }, workspace.workspaceId))
                ]
              }
            )
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.mode") }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
              "select",
              {
                className: kanban_default["bga-kb-select"],
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "", children: t("exec.mode.default") }),
                  options.presets.map((preset) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("option", { value: preset.id, disabled: preset.broken !== void 0, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.permission") }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
              "select",
              {
                className: kanban_default["bga-kb-select"],
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "", children: t("exec.permission.default") }),
                  TASK_PERMISSIONS.map((id) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: id, children: t(`exec.permission.${id}`) }, id))
                ]
              }
            )
          ] }),
          error !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: kanban_default["bga-kb-fld-error"], children: error }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("footer", { className: kanban_default["bga-kb-modal-foot"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-ghost"], onClick: onClose, children: t("new.cancel") }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "submit", className: kanban_default["bga-kb-btn-primary"], children: t("new.submit") })
          ] })
        ]
      }
    ) }),
...
function phraseTemplates(category) {
  switch (category) {
    case "business":
      return ["\u5B8C\u6210\u9700\u6C42 X \u7684\u6280\u672F\u65B9\u6848\u8BBE\u8BA1", "\u4FEE\u590D X bug \u5E76\u4E0A\u7EBF", "\u5B8C\u6210\u9700\u6C42 X \u7684\u5F00\u53D1\u4E0E\u81EA\u6D4B"];
    case "ops":
      return ["\u53D1\u5E03 vX \u5230\u9884\u53D1\u73AF\u5883", "\u6392\u67E5\u5E76\u4FEE\u590D\u7EBF\u4E0A\u544A\u8B66 X", "\u5DE1\u68C0\u5404\u670D\u52A1\u8FD0\u884C\u72B6\u6001"];
    case "management":
      return ["\u7EC4\u7EC7\u5468\u4F1A\u5E76\u8F93\u51FA\u7EAA\u8981", "\u8DDF\u8FDB X \u7684\u8FDB\u5EA6\u5E76\u540C\u6B65", "\u6574\u7406\u8FED\u4EE3\u8BA1\u5212\u4E0E\u6392\u671F"];
    case "support":
      return ["\u9700\u8981 X \u7EC4\u63D0\u4F9B\u6743\u9650\u652F\u6301", "\u9700\u8981 X \u534F\u52A9\u6392\u67E5\u95EE\u9898", "\u9700\u8981 X \u63D0\u4F9B\u6570\u636E\u652F\u6491"];
    default:
      return [];
  }
}
...
var TrashIcon = () => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("svg", { viewBox: "0 0 24 24", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [
  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M3 6h18" }),
  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" }),
  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6" }),
  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M10 11v6" }),
  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M14 11v6" })
] });
function TaskCardInner({ task, onClick, onDelete }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: kanban_default["bga-kb-card-top"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "button",
            {
              type: "button",
              className: kanban_default["bga-kb-card-title"],
              onClick: (event) => {
        ...
        task.description !== "" && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: kanban_default["bga-kb-card-excerpt"], children: task.description }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: kanban_default["bga-kb-card-meta"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: kanban_default["bga-kb-card-time"], children: [
            t("board.updated"),
            " ",
            formatTime(task.updatedAt)
          ] }),
          task.schedule?.enabled === true && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "span",
            {
          ...
          latest !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: kanban_default["bga-kb-card-run"], "data-result": latest.result, children: [
            runs,
            " ",
            t("board.runs")
          ] }),
          latest?.sessionId !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: kanban_default["bga-kb-card-session"], title: latest.sessionId, children: "\u2301" }),
          task.status === "running" && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: kanban_default["bga-kb-card-spinner"], "aria-hidden": "true" })
        ] }),
        latest !== void 0 && executionLabel(latest) === "running" && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: kanban_default["bga-kb-card-running"], children: [
...
var TaskCard = (0, import_react11.memo)(TaskCardInner);
...
function ExecutionRow({ execution, onOpen }) {
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("li", { className: kanban_default["bga-kb-ex-row"], "data-result": result, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: kanban_default["bga-kb-ex-badge"], "data-result": result, children: result === void 0 ? t("detail.result.running") : t(RESULT_KEY[result]) }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { className: kanban_default["bga-kb-ex-times"], children: [
        t("detail.executionStarted"),
        " ",
        formatTime(execution.startedAt),
        execution.endedAt !== void 0 && ` \xB7 ${t("detail.executionEnded")} ${formatTime(execution.endedAt)}`
      ] }),
      execution.sessionId !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        "button",
        {
          type: "button",
      ...
      execution.error !== void 0 && execution.error !== "" && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: kanban_default["bga-kb-ex-error"], children: execution.error })
    ] })
  );
}
...
function ExecutionSettingsSection({ controller, task }) {
  const [options, setOptions] = (0, import_react12.useState)(controller.getSnapshot().executionOptions);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { className: kanban_default["bga-kb-det-section"], children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h4", { children: t("detail.executionSettings") }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: kanban_default["bga-kb-det-text"], children: t("exec.hint") }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.workspace") }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("option", { value: "", children: t("exec.workspace.recent") }),
            !workspaceKnown && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("option", { value: workspaceId, children: [
              workspaceId,
              t("exec.mode.removed")
            ] }),
            options.workspaces.map((workspace) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("option", { value: workspace.workspaceId, children: workspace.title }, workspace.workspaceId))
          ]
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.mode") }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        "select",
        {
          className: kanban_default["bga-kb-select"],
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("option", { value: "", children: t("exec.mode.default") }),
            !modeKnown && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("option", { value: mode, children: [
              mode,
              t("exec.mode.removed")
            ] }),
            options.presets.map((preset) => /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("option", { value: preset.id, disabled: preset.broken !== void 0, children: [
              preset.name ?? preset.id,
              preset.isDefault ? t("exec.mode.defaultSuffix") : "",
              preset.broken !== void 0 ? t("exec.mode.brokenSuffix") : ""
            ] }, preset.id))
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("new.permission") }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        "select",
        {
          className: kanban_default["bga-kb-select"],
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("option", { value: "", children: t("exec.permission.default") }),
            TASK_PERMISSIONS.map((id) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("option", { value: id, children: t(`exec.permission.${id}`) }, id))
          ]
        }
      )
    ] })
...
function ScheduleSection({ controller, task }) {
  const schedule = task.schedule;
  const [cron, setCron] = (0, import_react12.useState)(schedule?.cron ?? "0 9 * * *");
  const [enabled, setEnabled] = (0, import_react12.useState)(schedule?.enabled ?? false);
  const [nextRunAt, setNextRunAt] = (0, import_react12.useState)(schedule?.nextRunAt);
  const [lastTriggeredAt, setLastTriggeredAt] = (0, import_react12.useState)(schedule?.lastTriggeredAt);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { className: kanban_default["bga-kb-det-section"], children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h4", { children: t("detail.schedule") }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("label", { className: kanban_default["bga-kb-sch-toggle"], children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { children: t("detail.schedule.enable") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: kanban_default["bga-kb-sch-row"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        "input",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        "select",
        {
          ...
          children: [
            ...
            SCHEDULE_PRESETS.map((preset) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("option", { value: preset.cron, children: t(preset.label) }, preset.cron))
          ]
        }
      )
    ] }),
    error !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: kanban_default["bga-kb-fld-error"], children: error }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("p", { className: kanban_default["bga-kb-sch-meta"], children: [
...
function TitleField({ controller, task }) {
  ...
  const [draft, setDraft] = (0, import_react12.useState)(task.title);
  (0, import_react12.useEffect)(() => {
    setDraft(task.title);
  }, [task.id, task.title]);
  const save = () => {
  ...
  if (!editable) {
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h2", { className: kanban_default["bga-kb-det-title"], children: task.title });
  }
...
function DescriptionSection({ controller, task }) {
  const editable = task.status === "backlog" || task.status === "todo";
  const [draft, setDraft] = (0, import_react12.useState)(task.description);
  (0, import_react12.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { className: kanban_default["bga-kb-det-section"], children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h4", { children: t("detail.description") }),
    editable ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "textarea",
      {
        className: kanban_default["bga-kb-input"],
        rows: 3,
    ...
    ) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: kanban_default["bga-kb-det-text"], children: task.description !== "" ? task.description : "\u2014" })
  ] });
}
function PromptSection({ controller, task }) {
  const editable = task.status === "backlog" || task.status === "todo";
  const [draft, setDraft] = (0, import_react12.useState)(task.prompt);
  (0, import_react12.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { className: kanban_default["bga-kb-det-section"], children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h4", { children: t("detail.prompt") }),
    editable ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "textarea",
      {
        className: kanban_default["bga-kb-input"],
    ...
    ) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("pre", { className: kanban_default["bga-kb-prompt"], children: task.prompt !== "" ? task.prompt : task.title })
  ] });
}
function TaskDetail({ controller, task }) {
  const dialogRef = (0, import_react12.useRef)(null);
  useDialogFocus(dialogRef);
  const [confirmDelete, setConfirmDelete] = (0, import_react12.useState)(false);
  const blurActive = () => {
    const el = document.activeElement;
    if (el instanceof HTMLElement && el !== document.body) el.blur();
  };
  ...
  const [latest, setLatest] = (0, import_react12.useState)(task);
  (0, import_react12.useEffect)(() => {
    setLatest(task);
  }, [task]);
  ...
  return (0, import_react_dom2.createPortal)(
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: kanban_default["bga-kb-modal-bg"], onMouseDown: (event) => {
      if (event.target === event.currentTarget) {
        blurActive();
        controller.closeTask();
      }
    }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { ref: dialogRef, className: kanban_default["bga-kb-det"], role: "dialog", "aria-label": t("detail.title"), children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("header", { className: kanban_default["bga-kb-det-header"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TitleField, { controller, task: current }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: kanban_default["bga-kb-badge"], "data-status": current.status, children: t(STATUS_KEY[current.status]) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: kanban_default["bga-kb-det-body"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(DescriptionSection, { controller, task: current }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(PromptSection, { controller, task: current }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ExecutionSettingsSection, { controller, task: current }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ScheduleSection, { controller, task: current }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { className: kanban_default["bga-kb-det-section"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h4", { children: t("detail.execution") }),
            current.executions.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: kanban_default["bga-kb-det-text"], children: t("detail.noExecution") }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("ul", { className: kanban_default["bga-kb-ex-list"], children: [...current.executions].reverse().map((execution) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              ExecutionRow,
              {
                execution,
                onOpen: (sessionId) => {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { className: kanban_default["bga-kb-det-section"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h4", { children: t("board.status") }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: kanban_default["bga-kb-move"], children: MANUAL_STATUSES.map((status) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                type: "button",
                className: kanban_default["bga-kb-btn-ghost"],
          ...
          current.category === "support" && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { className: kanban_default["bga-kb-det-section"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h4", { children: t("matrix.support.advance") }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: kanban_default["bga-kb-move"], children: SUPPORT_STATUSES.map((status) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                type: "button",
                className: kanban_default["bga-kb-btn-ghost"],
                ...
                onClick: () => {
                  controller.updateTask(current.id, { supportStatus: status });
                },
                children: t(SUPPORT_LABEL_KEY[status])
              },
              status
            )) })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("footer", { className: kanban_default["bga-kb-det-foot"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            "button",
            {
              type: "button",
          ...
          current.archivedAt !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            "button",
            {
              type: "button",
              className: kanban_default["bga-kb-btn-primary"],
          ...
          ) : (current.status === "done" || current.status === "failed") && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            "button",
            {
              type: "button",
              className: kanban_default["bga-kb-btn-ghost"],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { className: kanban_default["bga-kb-det-meta"], children: [
            t("board.created"),
            " ",
      ...
      confirmDelete && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        ConfirmDialog,
        {
...
function todayKeyOf(now = /* @__PURE__ */ new Date()) {
...
function CellTaskRow({ controller, task, onOpen }) {
  const running = task.status === "running";
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
    "div",
    {
      className: matrix_default["bga-mx-task"],
      "data-status": task.status,
      onClick: (event) => {
        event.stopPropagation();
        onOpen(task.id);
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          ...
          {
            type: "checkbox",
            className: matrix_default["bga-mx-task-check"],
            checked: done,
            disabled: running,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          ...
          {
            type: "button",
            className: matrix_default["bga-mx-task-title"],
            onClick: (event) => {
              event.stopPropagation();
              onOpen(task.id);
            },
        ...
        task.category === "support" && task.supportStatus !== void 0 && task.status !== "done" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-support"], "data-status": task.supportStatus, children: t(SUPPORT_KEY[task.supportStatus] ?? "matrix.support.pending") }),
        task.dueDate !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: matrix_default["bga-mx-task-due"], children: [
          t("matrix.task.due"),
          " ",
          task.dueDate.slice(5)
        ] }),
        task.priority === "high" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-prio"], "data-prio": "high" }),
        task.executions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: matrix_default["bga-mx-task-exec"], "data-result": task.executions[task.executions.length - 1]?.result, children: [
          task.executions.length,
          "x"
        ] }),
        running && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-task-spinner"], "aria-hidden": "true" })
      ]
    }
  );
}
function MatrixView({ controller }) {
  const [snapshot, setSnapshot] = (0, import_react13.useState)(controller.getSnapshot());
  const [weekOffset, setWeekOffset] = (0, import_react13.useState)(0);
  const [prefill, setPrefill] = (0, import_react13.useState)(void 0);
  const [showNew, setShowNew] = (0, import_react13.useState)(false);
  const [filter, setFilter] = (0, import_react13.useState)("");
  const [exportOpen, setExportOpen] = (0, import_react13.useState)(false);
  const [exportHint, setExportHint] = (0, import_react13.useState)("");
  const [statsOpen, setStatsOpen] = (0, import_react13.useState)(false);
  const [categoryOpen, setCategoryOpen] = (0, import_react13.useState)(false);
  const [reminderOpen, setReminderOpen] = (0, import_react13.useState)(false);
  const [snoozedReminder, setSnoozedReminder] = (0, import_react13.useState)(false);
  const exportRef = (0, import_react13.useRef)(null);
  (0, import_react13.useEffect)(() => {
    if (!exportOpen) return;
    const onMouseDown = (event) => {
      if (exportRef.current !== null && !exportRef.current.contains(event.target)) {
        setExportOpen(false);
      }
    };
  ...
  (0, import_react13.useEffect)(() => controller.subscribe(() => setSnapshot(controller.getSnapshot())), [controller]);
  const weekStart = weekStartOf(snapshot.meta);
  const categories = categoriesOf2(snapshot.meta.categories);
  const categoryLabel = (0, import_react13.useCallback)((id) => categoryLabelOf(snapshot.meta, id), [snapshot.meta]);
  const anchor = (0, import_react13.useMemo)(() => {
  ...
  const matches2 = (task) => needle === "" || task.title.toLowerCase().includes(needle) || task.description.toLowerCase().includes(needle);
  const openTask = (0, import_react13.useCallback)((id) => {
    controller.openTask(id);
  }, [controller]);
  const addInCell = (category, date) => {
    setPrefill({ category, date });
    setShowNew(true);
  };
  const toggleDay = (date) => {
    controller.toggleDayDone(date);
  };
  const copyText = (0, import_react13.useCallback)(async (text) => {
    try {
  ...
  const copyWeek = (0, import_react13.useCallback)(() => {
  ...
  const copyDay = (0, import_react13.useCallback)((date) => {
  ...
  const copyPlain = (0, import_react13.useCallback)(() => {
    void copyText(toPlainReport(weekReportMarkdown(snapshot.tasks, anchor, snapshot.meta.categories)));
    setExportOpen(false);
  }, [copyText, snapshot.tasks, anchor, snapshot.meta.categories]);
  const exportBackup = (0, import_react13.useCallback)(async () => {
    try {
  ...
  const dayStatusOf = (date) => dayStatus(snapshot.tasks, date, dayMeta.dayDoneAt);
  ...
  const [, setReminderTick] = (0, import_react13.useState)(0);
  (0, import_react13.useEffect)(() => {
  ...
  const reminderDue = (() => {
    ...
    return next !== void 0 && Date.now() >= next;
  })();
  const reminderTriggeredToday = reminder?.lastTriggeredAt !== void 0 && toDateKey(new Date(reminder.lastTriggeredAt)) === todayStr;
  const showReminderBanner = reminderDue && !snoozedReminder && !reminderTriggeredToday;
  const [draftCategories, setDraftCategories] = (0, import_react13.useState)([]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx"], children: [
    showReminderBanner && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-reminder"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("strong", { children: t("matrix.reminder.title") }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { children: t("matrix.reminder.body") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        "button",
        {
          ...
          children: t("matrix.reminder.gotIt")
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("header", { className: matrix_default["bga-mx-toolbar"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-week-nav"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-ghost"], onClick: () => {
          setWeekOffset(weekOffset - 1);
        }, "aria-label": t("matrix.prevWeek"), children: "\u2039" }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
          "button",
          {
            ...
            children: [
              isCurrentWeek ? t("matrix.thisWeek") : "",
              " ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-ghost"], onClick: () => {
          setWeekOffset(weekOffset + 1);
        }, "aria-label": t("matrix.nextWeek"), children: "\u203A" }),
        !isCurrentWeek && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-primary"], onClick: () => {
          setWeekOffset(0);
        }, children: t("matrix.today") }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: matrix_default["bga-mx-weekstart"], children: [
          t("matrix.weekStart"),
          ":",
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
            "button",
            {
              type: "button",
              className: weekStart === "monday" ? kanban_default["bga-kb-btn-primary"] : kanban_default["bga-kb-btn-ghost"],
              onClick: () => {
                controller.setWeekStart("monday");
              },
              children: t("matrix.weekStart.monday")
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
            "button",
            {
              type: "button",
              className: weekStart === "sunday" ? kanban_default["bga-kb-btn-primary"] : kanban_default["bga-kb-btn-ghost"],
              onClick: () => {
                controller.setWeekStart("sunday");
              },
              children: t("matrix.weekStart.sunday")
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-toolbar-right"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "input",
          {
        ...
        }, children: t("matrix.stats") }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-ghost"], onClick: openCategoryManager, children: t("matrix.categoryManage") }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-ghost"], onClick: () => {
          setReminderOpen(true);
        }, children: t("matrix.reminder.setting") }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { ref: exportRef, className: matrix_default["bga-mx-export"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
            "button",
            {
              type: "button",
          ...
          exportOpen && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-export-menu"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", onClick: copyWeek, children: t("matrix.export.week") }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", onClick: copyPlain, children: t("matrix.export.plain") }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", onClick: () => {
              void exportBackup();
            }, children: t("matrix.backup") }),
            days.map((date) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("button", { type: "button", onClick: () => {
              copyDay(date);
            }, children: [
              t("matrix.export.day"),
              " \xB7 ",
          ...
          exportHint !== "" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-export-hint"], children: exportHint })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("button", { type: "button", className: kanban_default["bga-kb-btn-primary"], onClick: () => {
          setPrefill(void 0);
          setShowNew(true);
        }, children: [
          "+ ",
    ...
    statsOpen && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(StatsPanel, { tasks: snapshot.tasks, days, categories, categoryLabel, onClose: () => {
      setStatsOpen(false);
    } }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-grid"], "data-week": isCurrentWeek ? "current" : "other", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-rowhead"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: matrix_default["bga-mx-corner"] }),
        categories.map((def) => {
          const count = snapshot.tasks.filter((task) => task.category === def.id && task.archivedAt === void 0).length;
          return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-rowhead-cell"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-rowhead-name"], children: def.label }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-rowhead-count"], children: count })
          ] }, def.id);
        })
      ] }),
      days.map((date) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-daycol"], "data-today": today || void 0, children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-dayhead"], "data-status": status, children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-dayhead-date"], children: [
              /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-dayhead-num"], children: Number(date.slice(8)) }),
              /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-dayhead-week"], children: weekdayName(date) }),
              today && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-dayhead-today"], children: t("matrix.today") })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
              "button",
              {
                type: "button",
                className: matrix_default["bga-mx-dayhead-badge"],
                "data-status": status,
                ...
                children: t(DAY_STATUS_KEY[status])
              }
            )
          ] }),
          categories.map((def) => {
            const tasks = snapshot.tasks.filter((task) => matches2(task) && task.category === def.id && task.reportDate === date && task.archivedAt === void 0).sort(byPriorityThenCreatedAt);
            return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
              "div",
              {
                className: matrix_default["bga-mx-cell"],
                "data-has-tasks": tasks.length > 0 || void 0,
                children: [
                  tasks.map((task) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(CellTaskRow, { controller, task, onOpen: openTask }, task.id)),
                  /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                    "button",
                    {
                      type: "button",
                      className: matrix_default["bga-mx-cell-add"],
                      "aria-label": t("matrix.cell.addHere"),
                      title: t("matrix.cell.addHere"),
                      onClick: () => {
                        addInCell(def.id, date);
                      },
    ...
    categoryOpen && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      CategoryManager,
      {
    ...
    reminderOpen && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      ReminderSettings,
      {
        controller,
        onClose: () => {
    ...
    showNew && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      NewTaskModal,
      {
        controller,
        onClose: () => {
        ...
        prefill: prefill === void 0 ? void 0 : { category: prefill.category, reportDate: prefill.date }
      }
    ),
    selected !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(TaskDetail, { controller, task: selected })
  ] });
}
function formatWeekRange(days) {
  const short = (key) => key.slice(5).replace("-", ".");
...
function StatsPanel({ tasks, days, categories, categoryLabel, onClose }) {
  ...
  const rows = categories.map((def) => {
    const weekTasks = tasks.filter(
      (task) => task.category === def.id && task.archivedAt === void 0 && task.reportDate !== void 0 && daySet.has(task.reportDate)
    );
  ...
  return (0, import_react_dom3.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: kanban_default["bga-kb-modal-bg"], onMouseDown: (event) => {
      if (event.target === event.currentTarget) onClose();
    }, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { ref: dialogRef, className: matrix_default["bga-mx-stats"], role: "dialog", "aria-label": t("matrix.stats.title"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h2", { className: kanban_default["bga-kb-modal-title"], children: t("matrix.stats.title") }),
      total === 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: matrix_default["bga-mx-stats-empty"], children: t("matrix.stats.noData") }),
      rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-stats-row"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-stats-label"], children: row.label }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-stats-bar"], children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "span",
          {
            className: matrix_default["bga-mx-stats-fill"],
            style: { width: `${Math.round(row.total / maxTotal * 100)}%` },
            "data-full": row.total >= maxTotal && row.total > 0 || void 0
          }
        ) }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: matrix_default["bga-mx-stats-num"], children: [
          row.done,
          "/",
          row.total,
          row.total > 0 ? ` \xB7 ${Math.round(row.done / row.total * 100)}%` : ""
        ] })
      ] }, row.id)),
      total > 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-stats-total"], children: [
        t("matrix.stats.total"),
        ": ",
        doneAll,
        "/",
        total,
        " \xB7 ",
        Math.round(doneAll / total * 100),
        "%"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("footer", { className: kanban_default["bga-kb-modal-foot"], children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: matrix_default["bga-mx-stats-close"], onClick: onClose, children: t("new.cancel") }) })
    ] }) }),
    document.body
  );
}
function CategoryManager({ initial, onChange, onCancel, onSave }) {
  const dialogRef = (0, import_react13.useRef)(null);
  useDialogFocus(dialogRef);
  const [id, setId] = (0, import_react13.useState)("");
  ...
  const add = () => {
    ...
    if (trimmedId === "" || trimmedLabel === "") {
      setError(t("matrix.category.emptyLabel"));
      return;
    }
    if (initial.some((def) => def.id === trimmedId)) {
      setError(t("matrix.category.dupId"));
      return;
    }
  ...
  return (0, import_react_dom3.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: kanban_default["bga-kb-modal-bg"], onMouseDown: (event) => {
      if (event.target === event.currentTarget) onCancel();
    }, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { ref: dialogRef, className: kanban_default["bga-kb-modal"], role: "dialog", "aria-label": t("matrix.categoryManage"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h2", { className: kanban_default["bga-kb-modal-title"], children: t("matrix.categoryManage") }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: matrix_default["bga-mx-cat-list"], children: initial.map((def) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-cat-item"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-cat-id"], children: def.id }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: matrix_default["bga-mx-cat-name"], children: def.label }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "button",
          {
            type: "button",
            ...
            title: initial.length <= 1 ? t("matrix.category.keepOne") : void 0,
            onClick: () => {
              remove(def.id);
            },
            children: t("matrix.category.remove")
          }
        )
      ] }, def.id)) }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: matrix_default["bga-mx-cat-new"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("input", { className: kanban_default["bga-kb-input"], placeholder: t("matrix.category.id"), value: id, onChange: (event) => {
          setId(event.target.value);
          setError("");
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("input", { className: kanban_default["bga-kb-input"], placeholder: t("matrix.category.label"), value: label, onChange: (event) => {
          setLabel(event.target.value);
          setError("");
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-primary"], onClick: add, children: t("matrix.category.add") })
      ] }),
      error !== "" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: kanban_default["bga-kb-fld-error"], children: error }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: matrix_default["bga-mx-cat-note"], children: t("matrix.category.removedNote") }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("footer", { className: kanban_default["bga-kb-modal-foot"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-ghost"], onClick: onCancel, children: t("new.cancel") }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-primary"], onClick: onSave, children: t("settings.save") })
      ] })
    ] }) }),
    document.body
  );
}
function ReminderSettings({ controller, onClose }) {
  const dialogRef = (0, import_react13.useRef)(null);
  useDialogFocus(dialogRef);
  const [snapshot, setSnapshot] = (0, import_react13.useState)(controller.getSnapshot());
  (0, import_react13.useEffect)(() => controller.subscribe(() => setSnapshot(controller.getSnapshot())), [controller]);
  const reminder = snapshot.meta.reminder;
  const [enabled, setEnabled] = (0, import_react13.useState)(reminder?.enabled ?? false);
  const [cron, setCron] = (0, import_react13.useState)(reminder?.cron ?? "0 21 * * *");
  ...
  return (0, import_react_dom3.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: kanban_default["bga-kb-modal-bg"], onMouseDown: (event) => {
      if (event.target === event.currentTarget) onClose();
    }, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { ref: dialogRef, className: kanban_default["bga-kb-modal"], role: "dialog", "aria-label": t("matrix.reminder.setting"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h2", { className: kanban_default["bga-kb-modal-title"], children: t("matrix.reminder.setting") }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("label", { className: kanban_default["bga-kb-fld"], children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: kanban_default["bga-kb-fld-label"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("input", { type: "checkbox", checked: enabled, onChange: (event) => {
          setEnabled(event.target.checked);
        } }),
        " ",
        t("matrix.reminder.enable")
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { className: kanban_default["bga-kb-fld"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: kanban_default["bga-kb-fld-label"], children: t("matrix.reminder.cron") }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("input", { className: kanban_default["bga-kb-input"], value: cron, onChange: (event) => {
          setCron(event.target.value);
        }, placeholder: "0 21 * * *" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: matrix_default["bga-mx-cat-note"], children: t("matrix.reminder.cronHint") }),
      !cronValid && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: kanban_default["bga-kb-fld-error"], children: t("detail.schedule.invalid") }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("footer", { className: kanban_default["bga-kb-modal-foot"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: kanban_default["bga-kb-btn-ghost"], onClick: onClose, children: t("new.cancel") }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "button",
          {
            type: "button",
...
var MemoTaskCard = (0, import_react14.memo)(function MemoTaskCard2({ task, onOpen, onDelete }) {
  const onClick = (0, import_react14.useCallback)(() => {
    onOpen(task.id);
  }, [task.id, onOpen]);
  const onDeleteTask = (0, import_react14.useCallback)(() => {
    onDelete(task.id);
  }, [task.id, onDelete]);
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(TaskCard, { task, onClick, onDelete: onDeleteTask });
});
function TaskBoard({ controller, embedded = false }) {
  const [snapshot, setSnapshot] = (0, import_react14.useState)(controller.getSnapshot());
  (0, import_react14.useEffect)(
    () => controller.subscribe(() => setSnapshot(controller.getSnapshot())),
    [controller]
  );
  const [view, setView] = (0, import_react14.useState)(embedded ? "board" : "matrix");
  const [filter, setFilter] = (0, import_react14.useState)("");
  const [quick, setQuick] = (0, import_react14.useState)("");
  const [showNew, setShowNew] = (0, import_react14.useState)(false);
  const [confirmDeleteId, setConfirmDeleteId] = (0, import_react14.useState)(void 0);
  const selected = selectedTaskOf(snapshot);
  ...
  const openTask = (0, import_react14.useCallback)((id) => {
    controller.openTask(id);
  }, [controller]);
  const requestDelete = (0, import_react14.useCallback)((id) => {
    setConfirmDeleteId(id);
  }, []);
  const quickAdd = (0, import_react14.useCallback)(() => {
    const title = quick.trim();
    if (title === "") return;
    controller.createTask({ title, description: "", prompt: "", kind: "todo" });
    setQuick("");
  }, [quick, controller]);
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: kanban_default["bga-kb-board"], "data-bga-kb-root": "", children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: kanban_default["bga-kb-viewbar"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: kanban_default["bga-kb-viewbar-tabs"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "button",
          {
            type: "button",
            className: view === "matrix" ? kanban_default["bga-kb-btn-primary"] : kanban_default["bga-kb-btn-ghost"],
            onClick: () => {
              setView("matrix");
            },
            children: t("board.view.matrix")
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "button",
          {
            type: "button",
            className: view === "board" ? kanban_default["bga-kb-btn-primary"] : kanban_default["bga-kb-btn-ghost"],
            onClick: () => {
              setView("board");
            },
            children: t("board.view.board")
          }
        )
      ] }),
      !embedded && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        "button",
        {
          type: "button",
          className: kanban_default["bga-kb-btn-ghost"],
    ...
    view === "matrix" ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(MatrixView, { controller }) : (
      /* —— 五列看板视图（执行流水线 + 归档） —— */
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("header", { className: kanban_default["bga-kb-board-header"], children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            "input",
            {
              className: kanban_default["bga-kb-search"],
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: kanban_default["bga-kb-cols"], children: archiveView ? /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("section", { className: kanban_default["bga-kb-col"], "data-status": "archived", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("header", { className: kanban_default["bga-kb-col-header"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h3", { className: kanban_default["bga-kb-col-title"], children: t("board.archive") }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: kanban_default["bga-kb-col-count"], children: visible.length })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: kanban_default["bga-kb-cards"], children: [
            visible.map((task) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(MemoTaskCard, { task, onOpen: openTask, onDelete: requestDelete }, task.id)),
            visible.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: kanban_default["bga-kb-col-empty"], children: t("archive.empty") })
          ] })
        ] }) : COLUMNS.map((column) => {
          const tasks = visible.filter((task) => task.status === column.status);
          return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("section", { className: kanban_default["bga-kb-col"], "data-status": column.status, children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("header", { className: kanban_default["bga-kb-col-header"], children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: kanban_default["bga-kb-dot"], "data-status": column.status, "aria-hidden": "true" }),
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h3", { className: kanban_default["bga-kb-col-title"], children: t(STATUS_KEY2[column.status]) }),
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: kanban_default["bga-kb-col-count"], children: tasks.length })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: kanban_default["bga-kb-cards"], children: [
              tasks.map((task) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(MemoTaskCard, { task, onOpen: openTask, onDelete: requestDelete }, task.id)),
              tasks.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: kanban_default["bga-kb-col-empty"], children: t("board.empty") })
            ] })
          ] }, column.status);
        }) }),
        selected !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(TaskDetail, { controller, task: selected }),
        showNew && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          NewTaskModal,
          {
            controller,
            onClose: () => {
        ...
        confirmTarget !== void 0 && (0, import_react_dom4.createPortal)(
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            ConfirmDialog,
            {
              title: t("delete.title"),
...
function mountBoard(controller) {
  ...
  const ensure = () => {
    ...
    root.render(/* @__PURE__ */ (0, import_jsx_runtime12.jsx)(TaskBoard, { controller }));
  };
  const applyOpen = () => {
...
function WelcomeBannerRow() {
  const config = useBannerConfig(DEFAULT_TEXT);
  if (!config.show) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: embed_default["bga-kb-embed-welcome"], "data-bga-welcome-row": "", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("img", { src: AVATAR_URL, alt: "", style: avatarStyle2 }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { style: textStyle2, children: config.text })
  ] });
}
...
function TaskBoardEmbed({ controller }) {
  ...
  (0, import_react15.useEffect)(() => setupHeroHeadlineHider(), []);
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { ref, className: embed_default["bga-kb-embed"], "data-bga-kb-embed-view": "", children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(WelcomeBannerRow, {}),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: embed_default["bga-kb-embed-body"], children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(TaskBoard, { controller, embedded: true }) })
  ] });
}
...
function mountBoardEmbed(controller) {
  ...
  root.render(/* @__PURE__ */ (0, import_jsx_runtime15.jsx)(TaskBoardEmbed, { controller }));
  return () => {
    root.unmount();
    container.remove();
  };
...
function PluginSettingsCard(props) {
  ...
  if (!state.exposed) {
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("li", { className: cardClass, children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: cfg_card_default["bga-kb-cfg-head-text"], children: [
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: cfg_card_default["bga-kb-cfg-name"], title, children: title }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: cfg_card_default["bga-kb-cfg-desc"], title: description, children: description })
            ] }),
      ...
      open ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: cfg_card_default["bga-kb-cfg-body"], children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", { className: cfg_card_default["bga-kb-cfg-hidden"], role: "status", children: props.t("settings.notExposed") }) }) : null
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("li", { className: cardClass, children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          state.dirty ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: cfg_card_default["bga-kb-cfg-pending"], title: props.t("settings.unsaved"), children: props.t("settings.unsaved") }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            "svg",
            {
              width: "14",
    ...
    open ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: cfg_card_default["bga-kb-cfg-body"], children: [
      !state.writable ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", { className: cfg_card_default["bga-kb-cfg-ro"], role: "status", children: props.t("settings.readOnly") }) : null,
      props.children,
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: cfg_card_default["bga-kb-cfg-foot"], children: [
        state.failed ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("p", { className: cfg_card_default["bga-kb-cfg-failed"], role: "status", children: [
...
function BooleanField(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: cfg_card_default["bga-kb-cfg-field"], children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: cfg_card_default["bga-kb-cfg-head"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("label", { className: cfg_card_default["bga-kb-cfg-label"], htmlFor: props.id, children: props.label }),
      props.overridden ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: cfg_card_default["bga-kb-cfg-badges"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: cfg_card_default["bga-kb-cfg-badge"], children: props.overriddenLabel }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("option", { value: "", children: props.inheritLabel }),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("option", { value: "true", children: props.onLabel }),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("option", { value: "false", children: props.offLabel })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", { className: cfg_card_default["bga-kb-cfg-hint"], children: props.hint })
  ] });
}

// src/client/compat/runtime-modules.ts
var SNAPSHOT_STORE_SPECS = [
...
var snapshotStore;
function snapshotStoreFactory() {
  if (snapshotStore !== void 0) return snapshotStore;
  const failures = [];
...
// src/client/compat/host-bridge.ts
var RPC_CHANNEL = "/api";
async function callHostRpc(connection, endpoint, args = {}, signal) {
  ...
  if (typeof fn !== "function") {
    throw new Error(
      `[bga-dsh-workbench] \u5BBF\u4E3B RPC \u4E0D\u53EF\u7528\uFF1A${endpoint}\uFF08\u65B0\u7248\u7684 rpc.call \u4E0E\u65E7\u7248\u7684 api.${ns}.${method} \u5747\u7F3A\u5931\uFF09`
    );
  }
  const response = await fn(args, signal);
  return response.result;
}
function connectWorkspace(ctx, workspaceId) {
  const shape = ctx;
  ...
  throw new Error(
    "[bga-dsh-workbench] \u65E0\u6CD5\u8FDE\u63A5\u5DE5\u4F5C\u533A\uFF1AuiWorkspace.connectWorkspace\uFF08\u65B0\u7248\uFF09\u4E0E workspaces.connectWorkspace\uFF08\u65E7\u7248\uFF09\u5747\u4E0D\u53EF\u7528"
  );
}
  ...
  const mountUi = () => {
    ...
    const exec = new ExecutionService({
      ...
      workspaces: {
        ...
        connectWorkspace: (id) => connectWorkspace(ctx, id)
      },
      // agent 预设能力：仅当连接可用时提供（用于任务运行参数中的「模式/预设」选择）
      presets: connection !== void 0 ? {
        select: async (sessionId, agentPreset) => {
          try {
            const response = await callHostRpc(connection, "agentPresets/select", { sessionId, agentPreset });
      ...
      history: connection !== void 0 ? {
        loadTail: async (sessionId) => {
          try {
            const response = await callHostRpc(connection, "sessions/history", { sessionId, maxMessages: 20 });
...
function apply(ctx) {
  ctx.effect(() => {
    ...
    root.render(/* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(WorkbenchBanner, {}),
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(ConfettiLayer, {}),
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(EnglishLearningLayer, {})
    ] }));
    return () => {
      root.unmount();
      container.remove();
    ...
    inject: () => ({
      ...
      load: async () => {
        ...
        return {
          ...
          theme: typeof value.confetti?.theme === "string" && ["default", "gold", "ocean", "sakura", "neon"].includes(value.confetti.theme) ? value.confetti.theme : "default",
          intensity: typeof value.confetti?.intensity === "string" && ["small", "medium", "large", "epic"].includes(value.confetti.intensity) ? value.confetti.intensity : "large",
          trigger: typeof value.confetti?.trigger === "string" && ["success", "every", "task"].includes(value.confetti.trigger) ? value.confetti.trigger : "success",
